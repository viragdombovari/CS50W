...
def unfollow(request):
    ...
    currentUser = User.objects.get(pk=request.user.id)
    userfollowData = User.objects.get(username=userfollow)
    follow = Follow.objects.filter(user=currentUser, user_follower=userfollowData).first()
    #follow = Follow.objects.get(user=currentUser, user_follower=userfollowData).first()
    if follow:
        follow.delete()
    #f.delete()
    user_id = userfollowData.id
